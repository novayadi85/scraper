...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Jeppe Admin v.1 | Admin Dashboard</title>
        ...
        <link href="resources/assets/global/plugins/jquery-chosen/chosen.css" rel="stylesheet" type="text/css" />
        ...
        <link href="resources/assets/global/plugins/bootstrap-toastr/toastr.css" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" type="text/css" href="resources/assets/global/plugins/jquery-nestable/jquery.nestable.css"/>
        <link rel="stylesheet" type="text/css" href="resources/assets/global/plugins/pace/themes/pace-theme-barber-shop.css"/>
		...
		<link href="resources/assets/global/plugins/introjs/introjs.css" rel="stylesheet" type="text/css" />
		<link href="resources/assets/global/plugins/loadingjs/loading.css" rel="stylesheet" type="text/css" />
		...
		<script src="resources/assets/global/plugins/jquery-chosen/chosen.jquery.js" type="text/javascript"></script>
		<script type="text/javascript" src="resources/assets/global/plugins/datatables/datatables.all.min.js"></script>
		<script src="resources/assets/global/plugins/loadingjs/loading.js" type="text/javascript"></script>
        <script src="https://theis-vine.dk/backend/design/template_12/global/plugins/jquery-nestable/jquery.nestable.js?v=1517549524"></script>
		<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
		<script src="resources/assets/global/scripts/sinov.js" type="text/javascript"></script>
        <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/angularjs/1.6.9/angular.min.js"></script>
		<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.7.2/Chart.min.js"></script>
        <script type="text/javascript" src="resources/assets/apps/scripts/chart.js"></script>
		<script>
		<?
		if(isset($_GET["unset"]) && $_GET["unset"] == "true"){
		?>
			window.open("<? print $referer; ?>","_self")
		<?
		}
		?>
		</script>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
		...
		<div class="page-wrapper">
                           ...
                           <!-- BEGIN USER LOGIN DROPDOWN -->
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" class="img-circle" src="resourse/assets/layouts/layout/img/avatar3_small.jpg" />
            ...
            <div class="page-container">
                ...
                <div class="page-sidebar-wrapper">
                    ...
                    <div class="page-sidebar navbar-collapse collapse">
                        ...
                        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <li class="nav-item start <?php print (strtolower($page) == "backend") ? "active" : "";?>">
                                <a href="/system/index.php" class="nav-link nav-toggle">
                                    <i class="icon-home"></i>
                                    <span class="title">Dashboard</span>
                                    <span class="<?php print (strtolower($page) == "") ? "selected" : "";?>"></span>
                                </a>
                                
                            </li>
							<li class="heading">
                                <h3 class="uppercase">Apps Shopify</h3>
                            </li>
							<li class="nav-item <?php print (strtolower($page) == "collections") ? "active" : "";?>">
								<a href="/system/index.php?page=collections" class="nav-link nav-toggle">
                                    <i class="icon-home"></i>
                                    <span class="title">Collections</span>
                                    <span class="<?php print (strtolower($page) == "collections") ? "selected" : "";?>"></span>
                                    
                                </a>
							 </li>
							<li class="nav-item <?php print (strtolower($page) == "scraper") ? "active" : "";?>">
								<a href="/system/index.php?page=scraper" class="nav-link nav-toggle">
                                    <i class="icon-home"></i>
                                    <span class="title">Scraper</span>
                                    <span class="<?php print (strtolower($page) == "scraper") ? "selected" : "";?>"></span>  
                                </a>
								<ul class="sub-menu">
									<li>
										<a href="/system/index.php?page=scraper">Scraper</a>
									</li>
									<li>
										<a href="/system/index.php?page=shopify">Upload til Shopify</a>
									</li>
									<li>
										<a href="/system/index.php?page=redirect">Redirect URLS</a>
									</li>
								</ul>
							 </li>
                            <li class="heading">
							...
							<li class="nav-item <?php print (strtolower($page) == "user") ? "active" : "";?>">
								<a href="/system/index.php?page=user" class="nav-link nav-toggle">
                                    <i class="icon-home"></i>
                                    <span class="title">Customer</span>
                                    <span class="<?php print (strtolower($page) == "user")  ? "selected" : "";?>"></span>
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
							...
							">
								...
								if(isset($_SESSION["cId"]) && !empty($_SESSION["cId"]) && $_SESSION["cId"]){
									print $_SESSION["cName"];	
								?>
								&nbsp;<a href="?unset=true">Unset Customer</a>
								<?
								}
								?>
								</li>
						...
						<div class="row">
                            <div class="col-md-12">
								<? include(__DIR__ . "/resources/page.php"); ?>
            ...
            <div class="page-footer">
                <div class="page-footer-inner"> 2018 &copy; Siteloom By
                    Jeppe Kjærsgaard
                </div>
...
<![endif]-->
        ...
        <script src="resources/assets/global/plugins/horizontal-timeline/horizontal-timeline.js" type="text/javascript"></script>
		...
		<script src="resources/assets/global/plugins/bootstrap-toastr/toastr.min.js" type="text/javascript"></script>
		<script src="resources/assets/global/plugins/introjs/intro.js" type="text/javascript"></script>
        ...
        <script>
            $(document).ready(function()
            {
				...
				var doneTour = localStorage.getItem('doneTour');
				
				if(doneTour === "yeah!"){
					return;
				}
				else{
					var IntroSL = introJs().start();
				}	

				IntroSL.oncomplete(function() {
				  localStorage.setItem('doneTour', 'yeah!');
				})

				// add a flag when we exit
				IntroSL.onexit(function() {
				   localStorage.setItem('doneTour', 'yeah!');
				});
